...
# 加载命中音效
hit_sound = pygame.mixer.Sound("hit_sound.wav.mp3")  # 加载音效文件
...
player2_purple_bullet_speed = -3  # 紫色子弹速度
...
while running:
    ...
    # 更新虚线偏移
    line_offset = (line_offset + line_speed) % line_spacing
    ...
    for y in range(-line_length, WINDOW_HEIGHT, line_spacing):
        # 左边虚线
        pygame.draw.line(window, WHITE, (10, y + line_offset), (10, y + line_length + line_offset), 2)
        # 右边虚线
        pygame.draw.line(window, WHITE, (WINDOW_WIDTH - 10, y + line_offset), (WINDOW_WIDTH - 10, y + line_length + line_offset), 2)
    ...
    # 画第二玩家紫色子弹
    for purple_bullet in player2_purple_bullets:
        pygame.draw.rect(window, purple_bullet["color"], (purple_bullet["x"], purple_bullet["y"], 8, 15))
    # 画第一玩家角色血条
    ...
    # 画第二玩家角色血条
    pygame.draw.rect(window, RED, (player2_x, player2_y + player2_height + 5, player2_width * (player2_health / 100), 10))
